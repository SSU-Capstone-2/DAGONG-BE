...
public enum SuccessStatus implements BaseCode {
    ...
    GROUP_PURCHASE_MINE_OK(HttpStatus.OK, "GROUP_PURCHASE2010", "사용자가 등록한 공동 구매 조회에 성공했습니다."),
    GROUP_PURCHASE_PARTICIPATING_OK(HttpStatus.OK, "GROUP_PURCHASE2011", "사용자가 참여중인 공동 구매 조회에 성공했습니다."),
    // 카카오 유저 확인 - 테스트용
